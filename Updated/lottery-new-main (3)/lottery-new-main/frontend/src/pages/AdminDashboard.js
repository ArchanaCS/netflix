...
import Purchaselotteryadmin from "../components/Purchaselottryadmin";
function Dashboard() {
  ...
  useEffect(() => {
    ...
    // ------<
    // Purchase list of tickets
    let url_purchaselist = config.url + "ticketpurchaselist";
    let request_purchaselist = {};
    let header_purchaselist = {};

    // let url_updatestatus = config.url+"updatepurchase";
    // let request_updatestatus = {id:id};
    // let header_updatestatus = {};
    // //uservalidationfetch----->
    ...
    axios
      ...
      .catch();
    axios
      .post(url_purchaselist, request_purchaselist, header_purchaselist)
      .then((res) => {
  ...
  const updatestatus = (e, id) => {
    ...
    let header_updatestatus = {};
    axios
      .post(url_updatestatus, request_updatestatus, header_updatestatus)
      .then((res) => {
      ...
      <div className="AdminDashboard_main">
        <div className="AdminDashboard_main_col_left">
          <Sidemenu
            ...
            label1={"Filter"}
            label2={"Lottery Manager"}
            label3={"Add Result"}
            label4={"Add Lottery"}
            label5={"Add Provider"}
            label6={"Update Result"}
            label7={"Purchase Summary"}
            label8={"Purchase details"}
            label9={"Result"}
          />
        </div>
