...
export default function AddLottery() {
  ...
  const handleAddlottery = () => {
    ...
    let req = {
      ...
      puramount: unitsaleamount-adminchargeperunit,
...
const subShow=(isShow)=>{
  ...
  const handleEditlottery = () => {
    ...
    var admin_charge=unitsaleamount - puramount;
    console.log(admin_charge)
        ...
        >
          <div className="AddLottery_labels">
            <div className="Addlott_req"  >
              ...
              /> */}
              <DatePicker  value={drawdate} selected={drawdate}   placeholderText={'Draw date'}  className="datePicker"  onChange={(date) => setLotterydate(date)} dateFormat="yyyy-MM-dd" />
              <BsCalendarDate/>
              
            </div>
            <div className="Addlott_req1">
              <Input
              isRequired="*"
                name="Ticket Cost"
                value={lotterycost}
            ...
            <div>
              ...
              isRequired="*"
                ...
                value={unitsaleamount-adminchargeperunit}
                onChange={(e) => {
